...
INSERT INTO @SourceRows (AttributeName, LanguageId, TranslatedAttribute) VALUES
  (N'defaultConsentMessage', 10000, N'By clicking Submit, I consent to receive Safety Check notifications through the selected notification channels.'),
  ...
  (N'defaultConsentMessage', 10002, N'By clicking Submit, I consent to receive Safety Check notifications through the selected notification channels.'),
  ...
  (N'defaultConsentMessage', 10121, N'By clicking Submit, I consent to receive Safety Check notifications through the selected notification channels.'),
  (N'defaultConsentMessage', 10122, N'By clicking Submit, I consent to receive Safety Check notifications through the selected notification channels.'),
  (N'defaultConsentMessage', 10123, N'By clicking Submit, I consent to receive Safety Check notifications through the selected notification channels.'),
  (N'defaultConsentMessage', 10124, N'By clicking Submit, I consent to receive Safety Check notifications through the selected notification channels.'),
  (N'defaultConsentMessage', 10125, N'By clicking Submit, I consent to receive Safety Check notifications through the selected notification channels.'),
  (N'defaultConsentMessage', 10126, N'By clicking Submit, I consent to receive Safety Check notifications through the selected notification channels.'),
  (N'defaultConsentMessage', 10127, N'By clicking Submit, I consent to receive Safety Check notifications through the selected notification channels.'),
  (N'defaultConsentMessage', 10128, N'By clicking Submit, I consent to receive Safety Check notifications through the selected notification channels.'),
  (N'defaultConsentMessage', 10129, N'By clicking Submit, I consent to receive Safety Check notifications through the selected notification channels.'),
  (N'defaultConsentMessage', 10130, N'By clicking Submit, I consent to receive Safety Check notifications through the selected notification channels.'),
  (N'defaultConsentMessage', 10131, N'By clicking Submit, I consent to receive Safety Check notifications through the selected notification channels.'),
  (N'defaultConsentMessage', 10132, N'By clicking Submit, I consent to receive Safety Check notifications through the selected notification channels.'),
  (N'defaultConsentMessage', 10133, N'By clicking Submit, I consent to receive Safety Check notifications through the selected notification channels.'),
  (N'defaultConsentMessage', 10134, N'By clicking Submit, I consent to receive Safety Check notifications through the selected notification channels.'),
