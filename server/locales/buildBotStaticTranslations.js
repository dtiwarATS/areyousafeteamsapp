...
const translations = {
  ...
  userCommentedNotification: {
    ...
    "10001":
      "L'utilisateur **<at>{ResponderName}</at>** a commenté pour l'incident **{IncidentTitle}** : \n{CommentVal} ",
    "10002":
      "User **<at>{ResponderName}</at>** has commented for incident **{IncidentTitle}**: \n{CommentVal} ",
    "10003":
      "المستخدم **<at>{ResponderName}</at>** علّق على الحادث **{IncidentTitle}**: \n{CommentVal} ",
    "10004":
      "Потребителят **<at>{ResponderName}</at>** коментира за инцидента **{IncidentTitle}**: \n{CommentVal} ",
    "10005":
      "L'usuari **<at>{ResponderName}</at>** ha comentat per a l'incident **{IncidentTitle}**: \n{CommentVal} ",
    "10006":
      "用户 **<at>{ResponderName}</at>** 对事件 **{IncidentTitle}** 发表了评论：\n{CommentVal} ",
    "10007":
      "使用者 **<at>{ResponderName}</at>** 對事件 **{IncidentTitle}** 發表了評論：\n{CommentVal} ",
    "10008":
      "Korisnik **<at>{ResponderName}</at>** je komentirao za incident **{IncidentTitle}**: \n{CommentVal} ",
    "10009":
      "Uživatel **<at>{ResponderName}</at>** okomentoval incident **{IncidentTitle}**: \n{CommentVal} ",
    "10010":
      "Brugeren **<at>{ResponderName}</at>** har kommenteret på hændelsen **{IncidentTitle}**: \n{CommentVal} ",
    "10011":
      "Gebruiker **<at>{ResponderName}</at>** heeft gereageerd op incident **{IncidentTitle}**: \n{CommentVal} ",
    "10012":
      "Kasutaja **<at>{ResponderName}</at>** kommenteeris juhtumit **{IncidentTitle}**: \n{CommentVal} ",
    "10013":
      "Käyttäjä **<at>{ResponderName}</at>** kommentoi tapausta **{IncidentTitle}**: \n{CommentVal} ",
    "10014":
      "L'utilisateur **<at>{ResponderName}</at>** a commenté pour l'incident **{IncidentTitle}** : \n{CommentVal} ",
    "10015":
      "Benutzer **<at>{ResponderName}</at>** hat den Vorfall **{IncidentTitle}** kommentiert: \n{CommentVal} ",
    "10016":
      "Ο χρήστης **<at>{ResponderName}</at>** σχολίασε για το περιστατικό **{IncidentTitle}**: \n{CommentVal} ",
    "10017":
      "המשתמש **<at>{ResponderName}</at>** הגיב על האירוע **{IncidentTitle}**: \n{CommentVal} ",
    "10018":
      "उपयोगकर्ता **<at>{ResponderName}</at>** ने घटना **{IncidentTitle}** पर टिप्पणी की: \n{CommentVal} ",
    "10019":
      "A felhasználó **<at>{ResponderName}</at>** hozzászólt az incidenshez **{IncidentTitle}**: \n{CommentVal} ",
    "10020":
      "Pengguna **<at>{ResponderName}</at>** mengomentari insiden **{IncidentTitle}**: \n{CommentVal} ",
    "10021":
      "L'utente **<at>{ResponderName}</at>** ha commentato l'incidente **{IncidentTitle}**: \n{CommentVal} ",
    "10022":
      "ユーザー **<at>{ResponderName}</at>** がインシデント **{IncidentTitle}** にコメントしました: \n{CommentVal} ",
    "10023":
      "사용자 **<at>{ResponderName}</at>** 님이 사건 **{IncidentTitle}** 에 댓글을 남겼습니다: \n{CommentVal} ",
    "10024":
      "Lietotājs **<at>{ResponderName}</at>** komentēja incidentu **{IncidentTitle}**: \n{CommentVal} ",
    "10025":
      "Vartotojas **<at>{ResponderName}</at>** pakomentavo incidentą **{IncidentTitle}**: \n{CommentVal} ",
    "10026":
      "Pengguna **<at>{ResponderName}</at>** mengulas insiden **{IncidentTitle}**: \n{CommentVal} ",
    "10027":
      "Brukeren **<at>{ResponderName}</at>** har kommentert hendelsen **{IncidentTitle}**: \n{CommentVal} ",
    "10028":
      "Użytkownik **<at>{ResponderName}</at>** skomentował incydent **{IncidentTitle}**: \n{CommentVal} ",
    "10029":
      "O usuário **<at>{ResponderName}</at>** comentou sobre o incidente **{IncidentTitle}**: \n{CommentVal} ",
    "10030":
      "O utilizador **<at>{ResponderName}</at>** comentou o incidente **{IncidentTitle}**: \n{CommentVal} ",
    "10031":
      "Utilizatorul **<at>{ResponderName}</at>** a comentat incidentul **{IncidentTitle}**: \n{CommentVal} ",
    "10032":
      "Пользователь **<at>{ResponderName}</at>** прокомментировал инцидент **{IncidentTitle}**: \n{CommentVal} ",
    "10033":
      "Korisnik **<at>{ResponderName}</at>** je komentarisao incident **{IncidentTitle}**: \n{CommentVal} ",
    "10034":
      "Používateľ **<at>{ResponderName}</at>** okomentoval incident **{IncidentTitle}**: \n{CommentVal} ",
    "10035":
      "Uporabnik **<at>{ResponderName}</at>** je komentiral incident **{IncidentTitle}**: \n{CommentVal} ",
    "10036":
      "El usuario **<at>{ResponderName}</at>** comentó sobre el incidente **{IncidentTitle}**: \n{CommentVal} ",
    "10037":
      "El usuario **<at>{ResponderName}</at>** comentó sobre el incidente **{IncidentTitle}**: \n{CommentVal} ",
    "10038":
      "Användaren **<at>{ResponderName}</at>** har kommenterat incidenten **{IncidentTitle}**: \n{CommentVal} ",
    "10039":
      "ผู้ใช้ **<at>{ResponderName}</at>** แสดงความคิดเห็นสำหรับเหตุการณ์ **{IncidentTitle}**: \n{CommentVal} ",
    "10040":
      "Kullanıcı **<at>{ResponderName}</at>** olay **{IncidentTitle}** için yorum yaptı: \n{CommentVal} ",
    "10041":
      "Користувач **<at>{ResponderName}</at>** прокоментував інцидент **{IncidentTitle}**: \n{CommentVal} ",
    "10042":
      "Người dùng **<at>{ResponderName}</at>** đã bình luận về sự cố **{IncidentTitle}**: \n{CommentVal} ",
    "10043":
      "Defnyddiwr **<at>{ResponderName}</at>** wedi rhoi sylw ar ddigwyddiad **{IncidentTitle}**: \n{CommentVal} ",
    "10044":
      "Erabiltzaileak **<at>{ResponderName}</at>** gertakari **{IncidentTitle}** iruzkin du: \n{CommentVal} ",
    "10045":
      "O usuario **<at>{ResponderName}</at>** comentou o incidente **{IncidentTitle}**: \n{CommentVal} ",
    "10046":
      "Gebruiker **<at>{ResponderName}</at>** het kommentaar gelewer op voorval **{IncidentTitle}**: \n{CommentVal} ",
    "10047":
      "Përdoruesi **<at>{ResponderName}</at>** ka komentuar për incidentin **{IncidentTitle}**: \n{CommentVal} ",
    "10048":
      "Օգտատերը **<at>{ResponderName}</at>** մեկնաբանել է **{IncidentTitle}** դեպքը: \n{CommentVal} ",
    "10049":
      "İstifadəçi **<at>{ResponderName}</at>** **{IncidentTitle}** hadisəsi üçün şərh yazdı: \n{CommentVal} ",
    "10050":
      "Карыстальнік **<at>{ResponderName}</at>** пракаментаваў інцыдэнт **{IncidentTitle}**: \n{CommentVal} ",
    "10051":
      "Korisnik **<at>{ResponderName}</at>** je komentarisao incident **{IncidentTitle}**: \n{CommentVal} ",
    "10052":
      "Ang user na **<at>{ResponderName}</at>** ay nagkomento para sa insidente **{IncidentTitle}**: \n{CommentVal} ",
    "10053":
      "მომხმარებელმა **<at>{ResponderName}</at>** დააკომენტარა ინციდენტი **{IncidentTitle}**: \n{CommentVal} ",
    "10054":
      "Notandinn **<at>{ResponderName}</at>** hefur skrifað athugasemd við atvikið **{IncidentTitle}**: \n{CommentVal} ",
    "10055":
      "D'fhreagair an t-úsáideoir **<at>{ResponderName}</at>** trácht ar an eachtra **{IncidentTitle}**: \n{CommentVal} ",
    "10056":
      "Пайдаланушы **<at>{ResponderName}</at>** **{IncidentTitle}** оқиғасына пікір қалдырды: \n{CommentVal} ",
    "10057":
      "Корисникот **<at>{ResponderName}</at>** коментираше за инцидентот **{IncidentTitle}**: \n{CommentVal} ",
    "10058":
      "Хэрэглэгч **<at>{ResponderName}</at>** **{IncidentTitle}** үйл явдалд сэтгэгдэл үлдээлээ: \n{CommentVal} ",
    "10059":
      "کاربر **<at>{ResponderName}</at>** برای رویداد **{IncidentTitle}** نظر داد: \n{CommentVal} ",
    "10060":
      "Mtumiaji **<at>{ResponderName}</at>** ametoa maoni kuhusu tukio **{IncidentTitle}**: \n{CommentVal} ",
    "10061":
      "பயனர் **<at>{ResponderName}</at>** சம்பவம் **{IncidentTitle}** க்கு கருத்து தெரிவித்துள்ளார்: \n{CommentVal} ",
    "10062":
      "వినియోగదారు **<at>{ResponderName}</at>** సంఘటన **{IncidentTitle}** పై వ్యాఖ్యానించారు: \n{CommentVal} ",
    "10063":
      "صارف **<at>{ResponderName}</at>** نے واقعے **{IncidentTitle}** پر تبصرہ کیا: \n{CommentVal} ",
    "10064":
      "Foydalanuvchi **<at>{ResponderName}</at>** **{IncidentTitle}** hodisasi bo'yicha izoh qoldirdi: \n{CommentVal} ",
  },
};

const languageIds = [];
for (let i = 10000; i <= 10064; i++) languageIds.push(String(i));

for (const key of Object.keys(translations)) {
  for (const langId of languageIds) {
    if (!translations[key][langId]) {
      throw new Error(`Missing ${key} translation for language ${langId}`);
    }
  }
}

const outPath = path.join(__dirname, "botStaticTranslations.json");
