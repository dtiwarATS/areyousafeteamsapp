...
IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'MSTeamsInstallationDetails' AND COLUMN_NAME = 'SENT_VOICE_CALL_COUNT') 
BEGIN 
 ALTER TABLE MSTeamsInstallationDetails ADD SENT_VOICE_CALL_COUNT int 
END 
GO

IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'MSTeamsInstallationDetails' AND COLUMN_NAME = 'SENT_WHATSAPP_COUNT') 
BEGIN 
 ALTER TABLE MSTeamsInstallationDetails ADD SENT_WHATSAPP_COUNT int 
END 
GO
...
ALTER TABLE MSTeamsMemberResponsesRecurr ALTER COLUMN RESPONSE_VALUE INT NULL
...
CREATE TABLE MSTeamsSOSResponder (
...
ALTER TABLE MSTEAMSTEAMSUSERS ADD SETUPCOMPLETED BIT NULL

ALTER TABLE MSTEAMSINSTALLATIONDETAILS ADD WHATSAPP_TOKEN NVARCHAR(MAX) NULL
ALTER TABLE MSTEAMSINSTALLATIONDETAILS ADD WHATSAPP_PHONE_NUMBER_ID NVARCHAR(200) NULL
...
BEGIN
  CREATE TABLE SETTINGS (
    ...
    TEAM_ID NVARCHAR(100) NOT NULL,
    USR_AAD_OBJ_ID NVARCHAR(255) NOT NULL,
    SETTING_NAME NVARCHAR(255) NOT NULL,
    SETTING_VALUE NVARCHAR(MAX) NULL
  );
  CREATE UNIQUE INDEX IX_SETTINGS_Lookup
    ON SETTINGS (TEAM_ID, USR_AAD_OBJ_ID, SETTING_NAME);
END
GO
